...
var query = connection.query('UPDATE portfolio SET ? WHERE id = '+req.params.id, project, function(err, result){
   console.log('Error: '+err);
   console.log('Success: '+result);
  });
...
router.delete('/delete/:id', function (req, res) {
  connection.query('DELETE FROM portfolio WHERE id = '+req.params.id, function (err, result) {
    if (err) throw err;
